    ...
    public void register() {
        var root = command("fakeplayer")
                ...
                .withSubcommands(
                        ...
                        command("info")
                                .withPermission(Permission.info)
                                .withShortDescription("fakeplayer.command.info.description")
                                .withRequirement(CommandSupports::hasFakeplayer)
                                .withOptionalArguments(fakeplayer("name"))
                        ...
                        command("block")
                                ...
                                .withShortDescription("fakeplayer.command.block.description")
                                .withRequirement(CommandSupports::hasFakeplayer)
                        ...
                        // 精确移动: /fp move <direction> <blocks> [name]
                        command("move")
                                .withShortDescription("fakeplayer.command.move.description")
                                .withPermission(Permission.move)
                                .withRequirement(CommandSupports::hasFakeplayer)
                                .withSubcommands(
                                        command("forward")
                                                .withShortDescription("fakeplayer.command.move.forward.description")
                                                .withArguments(int32("blocks", 1, 10000))
                                                .withOptionalArguments(fakeplayer("name"))
                                                .executes(moveCommand.moveBlocks(1, 0)),
                                        command("backward")
                                                .withShortDescription("fakeplayer.command.move.backward.description")
                                                .withArguments(int32("blocks", 1, 10000))
                                                .withOptionalArguments(fakeplayer("name"))
                                        ...
                                        command("left")
                                                ...
                                                .withArguments(int32("blocks", 1, 10000))
                                                .withOptionalArguments(fakeplayer("name"))
                                                .executes(moveCommand.moveBlocks(0, 1)),
                                        command("right")
                                                .withShortDescription("fakeplayer.command.move.right.description")
                                                .withArguments(int32("blocks", 1, 10000))
                                                .withOptionalArguments(fakeplayer("name"))
